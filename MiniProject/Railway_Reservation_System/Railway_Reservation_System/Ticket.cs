    ...
    class mark
    {
        ...
        static void Main(string[] args)
        {
            ...
            while (!exit)
            {
                ...
                Console.WriteLine("9. Download Ticket");
        ...
        // Builds the ticket content (same data as TicketReport) and returns it as a string
        ...
        // Writes the ticket string to the fixed folder path
